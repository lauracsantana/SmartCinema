...
public class ScreenControlServiceDiscovery {
        ...
        try {
            ...
            jmdns.addServiceListener(serviceType, new ServiceListener() {
                ...
                public void serviceAdded(ServiceEvent event) {
                    System.out.println("ScreenControl Service added: " + event.getInfo());
                }

                @Override
                public void serviceRemoved(ServiceEvent event) {
                    System.out.println("ScreenControl Service removed: " + event.getInfo());
                }

                @Override
                public void serviceResolved(ServiceEvent event) {
                    ServiceInfo serviceInfo = event.getInfo();
                    System.out.println("ScreenControl Service resolved: " + serviceInfo);
